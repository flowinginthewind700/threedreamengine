...
| Texture residency of a read-in UE level, 512 MiB budget | 2303.33 to 290.56 MiB across 380 maps: nothing dropped, resolution spent instead, and the maps that cannot move down from 62 to 2 |
...
| 一张读进来的 UE 关卡的纹理驻留，512 MiB 预算 | 380 张图 2303.33 到 290.56 MiB：一张没丢，花掉的是分辨率，动不了的从 62 张降到 2 张 |
