...
| Tests | 3,540 unit tests in 119 files, 65 browser tests, 68 Rust tests |
...
| 测试 | 119 个文件 3,540 个单元测试、65 个浏览器测试、68 个 Rust 测试 |
...
npm test          # 3,540 unit tests, no GPU needed
